...
void Kinetics::getNetProductionRates(doublereal* net)
{
    ...
    //Added by Nicolas Jaouen, adapted by Andrea Seltz on Cantera 2.4 // Jan 2019
    switch(Mechanism)
    {
       case 1 :
...
void Kinetics::setAOptim(std::vector<double> &Aoptim)
{
    m_Aoptim = Aoptim;
}

void Kinetics::getAOptim(std::vector<double> &Aoptim)
{
    Aoptim = m_Aoptim;
}

void Kinetics::setbOptim(std::vector<double> &boptim)
{
    m_boptim = boptim;
}

void Kinetics::getbOptim(std::vector<double> &boptim)
{
    boptim = m_boptim;
}

void Kinetics::setEOptim(std::vector<double> &Eoptim)
{
    m_Eoptim = Eoptim;
}

void Kinetics::getEOptim(std::vector<double> &Eoptim)
{
    Eoptim = m_Eoptim;
}
