...
//Ajout Nicolas Jaouen Decembre 2014//
//Ajout Andrea Seltz Janvier 2019 on Cantera 2.4//
extern int Mechanism;
extern void Reduced();
extern void Methane(Cantera::vector_fp& ropnet);
extern int Kerosene(int x);
//Fin ajout//
...
protected:
    ...
    //std::vector<std::map<int, doublereal> >     m_rrxn;
    //std::vector<std::map<int, doublereal> >     m_prxn;
