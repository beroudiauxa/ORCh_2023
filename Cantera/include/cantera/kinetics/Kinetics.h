...
extern void Reduced(doublereal *net);
...
public:
    ...
    // MAC: setter and getter functions used when reading optimized analytical mech to better take into account optimized coeff
    void setAOptim(std::vector<double> &Aoptim);
    void getAOptim(std::vector<double> &Aoptim);
    void setbOptim(std::vector<double> &boptim);
    void getbOptim(std::vector<double> &boptim);
    void setEOptim(std::vector<double> &Eoptim);
...
protected:
    ...
    // MAC: optimized coeff
    std::vector<double> m_Aoptim;
    std::vector<double> m_boptim;
    std::vector<double> m_Eoptim;
};
