...
public:
    ...
    double remeshFromSolution(int np, const double* z, const doublereal* x);
...
//Add Andrea Seltz 01/03/19
    int indxtp(int np,double val,const double* array);
...
protected:
    ...
    size_t m_nv, m_npmax;
    doublereal m_thresh;
    vector_fp m_z_new; //Add Andrea Seltz 
